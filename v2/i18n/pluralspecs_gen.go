...
// This file is generated by vs/i18n/codegen/generate.sh

// DefaultPluralSpecs returns a map of PluralSpecs
// generated from CLDR language data.
func DefaultPluralSpecs() map[string]*PluralSpec {
	specs := make(map[string]*PluralSpec)

	addPluralSpecs(specs, []string{"bm", "bo", "dz", "id", "ig", "ii", "in", "ja", "jbo", "jv", "jw", "kde", "kea", "km", "ko", "lkt", "lo", "ms", "my", "nqo", "root", "sah", "ses", "sg", "th", "to", "vi", "wo", "yo", "yue", "zh"}, &PluralSpec{
		Plurals: newPluralSet(Other),
		PluralFunc: func(ops *Operands) Plural {
			return Other
		},
	})
	addPluralSpecs(specs, []string{"am", "as", "bn", "fa", "gu", "hi", "kn", "mr", "zu"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"ff", "fr", "hy", "kab"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// i = 0,1
	...
	addPluralSpecs(specs, []string{"pt"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// i = 0..1
	...
	addPluralSpecs(specs, []string{"ast", "ca", "de", "en", "et", "fi", "fy", "gl", "it", "ji", "nl", "sv", "sw", "ur", "yi"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// i = 1 and v = 0
	...
	addPluralSpecs(specs, []string{"si"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"ak", "bh", "guw", "ln", "mg", "nso", "pa", "ti", "wa"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 0..1
			if ops.NInRange(0, 1) {
	...
	addPluralSpecs(specs, []string{"tzm"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 0..1 or n = 11..99
			if ops.NInRange(0, 1) ||
	...
	addPluralSpecs(specs, []string{"da"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"is"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"mk"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"fil", "tl"}, &PluralSpec{
		Plurals: newPluralSet(One, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"lv", "prg"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"lag"}, &PluralSpec{
		Plurals: newPluralSet(Zero, One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 0
			if ops.NEqualsAny(0) {
	...
	addPluralSpecs(specs, []string{"ksh"}, &PluralSpec{
		Plurals: newPluralSet(Zero, One, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 0
			if ops.NEqualsAny(0) {
	...
	addPluralSpecs(specs, []string{"iu", "kw", "naq", "se", "sma", "smi", "smj", "smn", "sms"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"shi"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"mo", "ro"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Other),
		PluralFunc: func(ops *Operands) Plural {
			// i = 1 and v = 0
			if intEqualsAny(ops.I, 1) && intEqualsAny(ops.V, 0) {
	...
	addPluralSpecs(specs, []string{"bs", "hr", "sh", "sr"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"gd"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"sl"}, &PluralSpec{
		Plurals: newPluralSet(One, Two, Few, Other),
		PluralFunc: func(ops *Operands) Plural {
			// v = 0 and i % 100 = 1
	...
	addPluralSpecs(specs, []string{"dsb", "hsb"}, &PluralSpec{
		Plurals: newPluralSet(One, Two, Few, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"he", "iw"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"cs", "sk"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"pl"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// i = 1 and v = 0
			if intEqualsAny(ops.I, 1) && intEqualsAny(ops.V, 0) {
	...
	addPluralSpecs(specs, []string{"be"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n % 10 = 1 and n % 100 != 11
			if ops.NModEqualsAny(10, 1) && !ops.NModEqualsAny(100, 11) {
	...
	addPluralSpecs(specs, []string{"lt"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"mt"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 1
			if ops.NEqualsAny(1) {
	...
	addPluralSpecs(specs, []string{"ru", "uk"}, &PluralSpec{
		Plurals: newPluralSet(One, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
	...
	addPluralSpecs(specs, []string{"br"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"ga"}, &PluralSpec{
		Plurals: newPluralSet(One, Two, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 1
			if ops.NEqualsAny(1) {
	...
	addPluralSpecs(specs, []string{"gv"}, &PluralSpec{
		Plurals: newPluralSet(One, Two, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// v = 0 and i % 10 = 1
			if intEqualsAny(ops.V, 0) && intEqualsAny(ops.I%10, 1) {
	...
	addPluralSpecs(specs, []string{"ar", "ars"}, &PluralSpec{
	...
	addPluralSpecs(specs, []string{"cy"}, &PluralSpec{
		Plurals: newPluralSet(Zero, One, Two, Few, Many, Other),
		PluralFunc: func(ops *Operands) Plural {
			// n = 0
			if ops.NEqualsAny(0) {

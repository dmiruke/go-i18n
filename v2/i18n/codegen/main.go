...
var codeTemplate = template.Must(template.New("spec").Parse(`package i18n
// This file is generated by i18n/codegen/generate.sh
...
{{range .PluralGroups}}
	addPluralSpecs(specs, {{printf "%#v" .SplitLocales}}, &PluralSpec{
...
var testTemplate = template.Must(template.New("spec").Parse(`package i18n
// This file is generated by v2/i18n/codegen/generate.sh
